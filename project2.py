...
def predict_production(df):
    ...
    area_production_relation = {'jute':15.5,'maize':2.8,'rice':1.6,'sugarcane':40,'wheat':2.1}
    ...
    price = np.array([1400,1850,1888,200,1925])                    
    each_crop_area_df['price'] = each_crop_area_df['production']*price                 
    print(each_crop_area_df)
